...
INSERT INTO temp_table (SELECT ssn, name, phone, email, city_name FROM transducer._SPERSON_INSERT);
...
ELSE
   ...
   INSERT INTO UJT (
   SELECT DISTINCT ssn, name, phone, email, city_name
...
ELSE
   ...
   THEN
      ...
      THEN
         ...
         /*Yeah, those two condition ain't up to par yet*/
...
INSERT INTO temp_table (SELECT ssn, name, phone, email, city_name
...
INSERT INTO temp_table (
   SELECT ssn, name, phone, email, city_name
